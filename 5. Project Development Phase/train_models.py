...
def main():
    ...
    os.makedirs('/home/david/credit_card_approval/5. Project Development Phase', exist_ok=True)
    ...
    df_sample.to_csv('/home/david/credit_card_approval/5. Project Development Phase/sample_applicants.csv', index=False)
